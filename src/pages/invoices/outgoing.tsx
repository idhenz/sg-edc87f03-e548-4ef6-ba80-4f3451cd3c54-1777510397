...
import { Plus, Search, Eye, Edit, Send, Download } from 'lucide-react'
      ...
      <AppLayout>
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">Invoice Keluar</h1>
          ...
          <Card>
            ...
            <CardContent>
              {loading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  {searchQuery ? 'Tidak ada data yang cocok dengan pencarian' : 'Belum ada invoice keluar'}
                </div>
              ) : (
